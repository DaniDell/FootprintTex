...
const Footer = () => {
  return (
    <Box sx={{ p: 1, position: 'relative', bottom: 0, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', backgroundColor: '#ffff', width: "100%", marginTop: "10px" }}>
